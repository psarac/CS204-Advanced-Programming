...
#include <fstream>
#include <sstream>
#include "psarac_Sarac_Pelinsu_hw6_Board.h" //change this with your board header file name
#include "psarac_Sarac_Pelinsu_hw6_Player.h" //change this with your player header file name
